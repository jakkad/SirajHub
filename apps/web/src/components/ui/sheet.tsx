...
import { Dialog as SheetNS } from "radix-ui";
import { X } from "lucide-react";
import { cva, type VariantProps } from "class-variance-authority";
import { cn } from "@/lib/utils";

const Sheet = SheetNS.Root;
const SheetTrigger = SheetNS.Trigger;
const SheetClose = SheetNS.Close;
const SheetPortal = SheetNS.Portal;

const SheetOverlay = React.forwardRef<
  React.ElementRef<typeof SheetNS.Overlay>,
  React.ComponentPropsWithoutRef<typeof SheetNS.Overlay>
>(({ className, ...props }, ref) => (
  <SheetNS.Overlay
    className={cn(
...
interface SheetContentProps
  extends React.ComponentPropsWithoutRef<typeof SheetNS.Content>,
    VariantProps<typeof sheetVariants> {}

const SheetContent = React.forwardRef<
  React.ElementRef<typeof SheetNS.Content>,
  SheetContentProps
...
const SheetDescription = React.forwardRef<
  React.ElementRef<typeof SheetNS.Description>,
  React.ComponentPropsWithoutRef<typeof SheetNS.Description>
>(({ className, ...props }, ref) => (
  <SheetNS.Description ref={ref} className={cn("text-sm text-muted-foreground", className)} {...props} />
));
