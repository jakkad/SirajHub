...
>(({ className, children, ...props }, ref) => (
  <SelectNS.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between whitespace-nowrap rounded-2xl border-2 border-[hsl(var(--border-strong))] bg-background px-4 py-2 text-sm shadow-[3px_3px_0_hsl(var(--shadow-ink))] ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
